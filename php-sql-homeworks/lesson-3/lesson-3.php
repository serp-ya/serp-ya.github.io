...
for ($i=0; $i < count($array_fst_word) ; $i++) { 			// Т.к. по условиям предыдущих операций, кол-во элементов не может отличаться в обоих массивах 
									// с вырезанными словами, не стал делать дополнительных проверок и задал кол-во итераций === кол-ву 
									// элементов в массиве с первыми словами
	
	echo "$array_fst_word[$i] $array_sec_word[$i]<br>";		// Выводим все первые слова вперемешку со всеми вторыми словами 
}
###################################################################
